import { TrafficIncident, MRTLineStatus, ServiceAdvisory, TrafficCamera } from '../types';
...
export const INITIAL_INCIDENTS: TrafficIncident[] = [
  ...
  },
  {
    id: 'inc-7',
    type: 'roadworks',
    title: 'SLE (Towards BKE)',
    expressway: 'SLE',
    location: 'SLE near Lentor Ave flyover',
    description: 'Scheduled asphalt resurfacing works on SLE westbound. Leftmost lane cordoned off.',
    timestamp: '2023-10-14T08:30:00',
    timeFormatted: '08:30 AM',
    severity: 'moderate',
    tags: ['SLE', 'RESURFACING'],
    latPercent: 20,
    lngPercent: 50,
    laneClosure: 'Lane 4 closed',
    estClearance: '3 hrs',
    speedKmh: 50,
  }
];
